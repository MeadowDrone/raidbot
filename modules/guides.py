def guides(instr):
    text = instr[6:]
    alex = [
        'that\'s not a raid number, silly',
    ...
    turns = [
        'that\'s not a turn, silly',
        'https://www.youtube.com/watch?v=ZIoyLNYyOzo',
        'https://www.youtube.com/watch?v=mqP2ooPB9ys',
        'https://www.youtube.com/watch?v=BdT2BFEX4I8',
        'https://www.youtube.com/watch?v=pb_hDiiBOi4',
        'https://www.youtube.com/watch?v=1fsPp9IQXuc',
        'https://www.youtube.com/watch?v=HVqe6D9UlkQ',
        'https://www.youtube.com/watch?v=zlFDCI-c9wE',
        'https://www.youtube.com/watch?v=IeUiwRI6rqM',
        'https://www.youtube.com/watch?v=K_lnPoQNu7w',
        'https://www.youtube.com/watch?v=9qBV21L37E0',
        'https://www.youtube.com/watch?v=3HRe4bLjpNk',
        'https://www.youtube.com/watch?v=d0zqDdg9zm4',
